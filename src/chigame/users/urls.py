...
urlpatterns = [
    ...
    path("invite_to_game/<int:pk>/<int:match_pk>/", view=invite_to_game, name="invite-to-game"),
    path("invite_to_tournament/<int:pk>/<int:match_pk>/", view=invite_to_tournament, name="invite-to-tournament"),
