...
tournament_patterns = [
    ...
    path(
        "<int:tournament_id>/feedback/",
        views.TournamentFeedbackListView.as_view(),
        name="api-tournament-feedback-list",
    ),
    path("feedback/", views.FeedbackCreateView.as_view(), name="api-feedback-create"),
]
