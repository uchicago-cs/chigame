...
from chigame.games.models import Category, Chat, Game, Lobby, Mechanic, Message, Review, Tournament, User, WordGameData
...
class WordGameDataSerializer(serializers.ModelSerializer):
    class Meta:
        model = WordGameData
